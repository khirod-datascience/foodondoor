...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Future<void> _updateOrderStatus(String newStatus) async {
    ...
    try {
      final order = Provider.of<OrderProvider>(context, listen: false).getOrderById(widget.orderId);
      if (order == null) throw Exception('Order not found');
      final result = await Provider.of<OrderProvider>(context, listen: false)
          .updateOrderStatus(order.id, order.orderNumber, newStatus);
      if (result && mounted) {
                        ...
                        Row(
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              disabledHint: Text(order.status),
                            ),
                            if (_isUpdating)
                              Padding(
