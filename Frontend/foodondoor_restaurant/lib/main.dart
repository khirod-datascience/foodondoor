...
const AndroidNotificationChannel vendorChannel = AndroidNotificationChannel(
  'vendor_notifications',
  'Vendor Notifications',
  description: 'Channel for vendor delivery notifications',
  importance: Importance.max,
  sound: RawResourceAndroidNotificationSound('vendor_delivery_ring'),
);
...
Future<void> setupNotificationChannels() async {
  ...
  print('[DEBUG] Vendor notification channel created');
}

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  // Create vendor notification channel BEFORE Firebase/FCM init
  ...
  if (authProvider.isAuthenticated) {
    ...
    try {
      // Pass vendorId explicitly for reliability
      SimpleNotificationService.instance.initialize(vendorId: globals.globalVendorId);
