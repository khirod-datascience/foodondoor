  ...
  Future<bool> verifyOtp(String phone, String otp) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _vendorId = responseData['vendorId'] as String?;
        debugPrint('(AuthProvider.verifyOtp) Login success. Got VendorID: [38;5;28m[0m[38;5;28m[0m[38;5;28m$_vendorId[0m, Token: ${_token != null}');

        // *** Crucial: Save credentials ***
        if (_vendorId != null && _token != null) {
          ...
          debugPrint('(AuthProvider.verifyOtp) ERROR: vendorId or token is null in response!');
        }
