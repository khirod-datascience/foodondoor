...
ALLOWED_HOSTS = ['127.0.0.1','192.168.225.54', '192.168.238.184', '0.0.0.0', '192.168.159.1','192.168.70.184']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # Default to AllowAny, protect views explicitly
        'rest_framework.permissions.AllowAny',
    ]
    # Add other DRF settings as needed
}

# Configure JWT settings (optional, defaults are often okay)
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'customer_id', # Field on your Customer model to identify user
